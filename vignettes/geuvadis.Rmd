---
title: "Example usage of zenith on GEUVAIDIS RNA-seq"
...
### Load RNA-seq data and sample metadata
```{r download}
...
#### Run gene set analysis with zenith
```{r zenith}
...
### Zenith can also test for differences in the squared test statistic
